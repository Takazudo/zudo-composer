...
const { releaseRoot, mediaRoot, compositionsRoot } = requireDevBrowserRoots(process.env);
...
export default defineConfig({
  ...
  webServer: {
    ...
    timeout: 30_000,
    env: { ...process.env, ZUDO_SITE_PROJECT_ROOT: releaseRoot, ZUDO_MEDIA_STORE_ROOT: mediaRoot, ZUDO_COMPOSITIONS_ROOT: compositionsRoot },
  },
});
