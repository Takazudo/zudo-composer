...
import { B as assetMimeTypeForExtension, F as assetAuthoringUrl, H as ASSET_PROVIDERS, _ as canonicalStringifyJson, t as validateSiteProject, x as createFilesystemAssetStore } from "./generated/validation-DV2V4ohB.mjs";
...
var ASSET_PROVIDER_ID = ASSET_PROVIDERS.files.id;
...
function imageUse(assetId, alt, options = {}) {
	const decorative = options.decorative ?? false;
	return {
		kind: "image",
		asset: {
			providerId: ASSET_PROVIDER_ID,
			assetId
		},
		alt: decorative ? "" : alt,
		decorative,
