...
// The iframe owns this CSS string so its editor chrome stays isolated from the
// host stylesheet and remains available in the dynamically loaded preview chunk.
//
...
//
// The palette is intentionally standalone. Issue #9 will import the provider's
// public CSS at this seam without changing the iframe protocol or renderer.
//
...
html[${COMPOSER_PREVIEW_DOC_ATTR}] {
  ...
  --color-bg:           light-dark(#f7f7f5, #171717);
  --color-surface:      light-dark(#ffffff, #222222);
  --color-surface-2:    light-dark(#ecebe7, #30302e);
  --color-fg:           light-dark(#20201f, #f5f5f2);
  --color-muted:        light-dark(#6c6b67, #aaa8a2);
  --color-accent:       light-dark(#6750a4, #c9b8ff);
  --color-accent-hover: light-dark(#513b8d, #dfd5ff);
  ...
  --color-border:      light-dark(#deddd8, #41403d);
  --sg-composer-guide: light-dark(oklch(.680 .008 65), oklch(.560 .008 65));
  --color-success: light-dark(#18794e, #70d7a5);
  --color-danger: light-dark(#b3261e, #ffb4ab);
  --color-warning: light-dark(#8a4f00, #ffb95c);
  --color-info: light-dark(#075985, #7dd3fc);
  --color-focus: light-dark(#3b67d8, #9eb8ff);
  --sg-composer-panel-bg: var(--color-surface);
  --spacing-hsp-xs: .5rem; --spacing-hsp-sm: .75rem; --spacing-hsp-md: 1rem; --spacing-hsp-lg: 1.25rem;
  --spacing-vsp-3xs: .2rem; --spacing-vsp-2xs: .25rem; --spacing-vsp-xs: .5rem; --spacing-vsp-sm: .75rem;
  --text-micro: .6875rem; --text-caption: .75rem; --text-small: .875rem;
  --font-mono: ui-monospace, SFMono-Regular, Menlo, monospace;
  --z-index-local-1: 1; --z-index-local-2: 2; --z-index-popover: 40; --z-index-modal-backdrop: 50; --z-index-modal: 60;
}
