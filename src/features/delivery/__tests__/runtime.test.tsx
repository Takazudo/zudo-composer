...
describe("trusted delivery props", () => {
  it("starts from defaults and accepts validated fields/static defaults only", () => {
    ...
    const asset = projectTrustedProps(node(cta.id, { children: "Download", href: "/uploaded-assets/brief.pdf?download=1#file", variant: "secondary", arrow: false }), cta)!;
    expect(asset).toMatchObject({ children: "Download", href: "/uploaded-assets/brief.pdf?download=1#file", variant: "secondary", arrow: false });
