...
export function ProductionSitemapperApp({ provider: suppliedProvider, catalog, mappingCatalog, idFactory, pageIdFactory, now }: ProductionSitemapperAppProps): JSX.Element {
