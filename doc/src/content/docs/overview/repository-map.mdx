...
| `wrangler*.jsonc` | Cloudflare Worker configurations for the ten hosted targets: the root-domain documentation site, the standalone sample styleguide, four static demo sites, and four per-host editors. |
