...
/** Keep the permanent app-provenance/UI-provenance/contract/UI-package set exact. A consumer
...
export function assertHandoffHashes({ readme, guidance, permanent }) {
  ...
  assert.deepEqual(hashes, new Set(permanent), "README/CLAUDE permanent identities must contain only the app provenance, UI provenance, contract package and UI package hashes");
}
