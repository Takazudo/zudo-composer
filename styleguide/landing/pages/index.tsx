...
// PreviewTokenPanelBootstrap and register it under its SSR marker.
import { BodyEndIslands } from "./lib/_body-end-islands";

export const frontmatter = { title: "Landing Styleguide" };
  ...
  return (
    <html lang="en">
      <head>
        ...
        <title>Landing Styleguide</title>
      </head>
      <body class="sg-home">
        <main class="sg-home__main">
          <p class="sg-home__eyebrow">Zudo Composer</p>
          <h1 class="sg-home__title" data-host-index>Landing Styleguide</h1>
          <p class="sg-home__intro">
            The Orrery landing page components in action, with real imagery,
