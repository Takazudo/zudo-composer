...
/**
 * The Vite alias that resolves `tailwindcss/*` CSS from the tool root. Shared
 * with the pack source graph so it attests the file Vite actually loads.
 * @returns {import("vite").Alias}
 */
export function tailwindResolverAlias() {
  ...
  return [
    {
      ...
      enforce: "pre",
      config() {
        return { resolve: { alias: [tailwindResolverAlias()] } };
      },
    },
    ...tailwindcss(),
  ];
