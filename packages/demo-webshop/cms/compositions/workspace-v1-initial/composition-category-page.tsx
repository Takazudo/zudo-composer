import { CartButton, CategoryBody, Container, Footer, Header, NavLink } from "demo-webshop/components";

export type CompositionOutlets = {
  "category-page-outlet"?: import("preact").ComponentChildren;
};
